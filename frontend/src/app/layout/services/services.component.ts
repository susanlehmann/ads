...
import { service_groupService } from './service.service';
...
export class ServicesComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private http: HttpClient,
    ...
    private service_groupService: service_groupService,
  ) {
    this.groupColors = [
  ...
  getGroup() {
    this.startLoading();
    this.service_groupService.getList()
  ...
  add(service_group): void {
    this.service_groupService.add(service_group)
    .subscribe((data:any) => {
      this.stopLoading();
      this.getGroup();
